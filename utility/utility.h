...
extern char *util_path_search ARGS((char *program));
extern char *util_file_search ARGS((char *file, char *path, char *mode));
extern int util_pipefork ARGS((char **argv, FILE **toCommand,
                               FILE **fromCommand));
extern int util_csystem ARGS((char *command));
extern char *util_print_time ARGS((long t));
extern char *util_strsav ARGS((char *ptr));
